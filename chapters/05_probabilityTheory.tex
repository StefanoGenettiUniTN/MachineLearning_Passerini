...
\section{Discrete random variables}
    ...
    \subsection{Pairs of discrete random variables}
        ...
        From these values we can get a coefficient of corrrelation as:
...
\section{Probability laws}
    ...
    \section{Information theory}
        ...
        $$H[\mathcal{V}] = E[-\log P(v)] = -\sum_{i=1}^n \log P(v_i)$$
        
        }
        
        \defi{\textbf{Cross entropy}\label{def:cross_entropy}\\
        Considering two distributions $P$ and $Q$ over a variable $X$, the cross entropy between the two distributions measures the expected number of bits needed to code a symbol samples from P using Q instead:
