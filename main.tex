...
\tableofcontents
    ...
    \input{chapters/09_InferenceInBN}
    \input{chapters/09.1_LearningBN}
    \input{chapters/10_BayesianNetworkLab}
    \input{chapters/11_LinearDiscriminantFunctions}
    \input{chapters/12_SupportVectiorMachines}
    \input{chapters/13_NonLinearSVMs}
    \input{chapters/14_KernelMachines}
    % \input{chapters/15_ScikitLearnLab}
    \input{chapters/16_DeepLearning}
    % \input{chapters/17_DeepLearningLab}
    \input{chapters/18_UnsupervidesLearning}
